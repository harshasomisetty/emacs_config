...
#+BEGIN_SRC emacs-lisp
   ...
   (use-package helm-bibtex
     ...
     (setq bibtex-completion-bibliography '("~/org/literature/refs.bib")
           )
   ...
   (use-package org-ref
     ...
     (setq org-ref-default-bibliography "~/org/literature/refs.bib"
     ...
     :bind (("C-c r c" . org-ref-indert-cite-function)
            ("C-c r r" . org-ref-indert-ref-function)
            ("C-c r l" . org-ref-indert-label-function)))
